...
<template>
  <div class="dao d-flex flex-column">
    ...
    <div
      class="font-weight-bold text-dp-lg align-self-center mt-12 mb-8 z-2"
      data-aos="fade-up"
    >
      DAO Builder pioneers the optimal way for
    </div>
    <div
      class="d-flex mt-12 justify-center col-gap-40 z-2 mb-5"
      data-aos="fade-right"
    >
      <div
    ...
    <div
      class="d-flex mt-2 justify-center col-gap-40 z-2 gray6--text"
      data-aos="fade-right"
    >
      <div
